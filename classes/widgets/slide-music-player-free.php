...
if ( !class_exists( "Widget_Slide_Music_Player_Free" ) ) {
    class Widget_Slide_Music_Player_Free extends Widget_Base {
        ...
        public function get_title() {
            return __( 'Music Player', 'music-player-for-elementor' );
        }
        ...
        public function get_icon() {
            return 'eicon-play-o mpack-widget-icon';
        }
        ...
        protected function register_controls() {
            ...
            $this->add_responsive_control( 'show_player_left_get_pro', [
                'label'       => __( 'Show/Hide Player Cover', 'music-pack' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'default'     => 'yes',
                'options'     => [
                    'yes' => esc_html( 'Yes - Show Cover', 'music-pack' ),
                    'no'  => esc_html( 'No - Hide Cover', 'music-pack' ),
                ],
                'label_block' => 'true',
            ...
            $repeater->add_control( 'buy_icon_pos_mobile', [
                'label'     => __( 'Icons Position (Mobile)', 'music-pack' ),
            ...
            $this->add_control( 'repeat_is_for_get_pro', [
                'label'       => __( 'Repeat Icon Applies To', 'music-pack' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'default'     => 'playlist',
                'options'     => [
                    'playlist'     => esc_html( 'Playlist', 'music-pack' ),
                    'current_song' => esc_html( 'Current Song', 'music-pack' ),
                ],
                'label_block' => 'true',
                'classes'     => 'mpfe-get-pro',
            ] );
        ...
        protected function render() {
            ...
            $repeat_mode = "unset";
            /*Warning: Trying to access array offset on value of type null in /home/mhd-01/www.wizardstudiolab.com/htdocs/wp-content/plugins/music-player-for-elementor-premium/classes/widgets/slide-music-player-free.php on line 2711*/
	...
	<?php 
        ...
        private function single_track_html( $song ) {
            ...
            $song_custom_img = ( mpack_fs()->can_use_premium_code__premium_only() && isset( $song['song_custom_img'] ) ? $song['song_custom_img']['url'] : "" );
            ?>
